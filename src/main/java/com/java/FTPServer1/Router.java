...
import com.java.FTPServer1.enums.Command;
import com.java.FTPServer1.enums.ResponseCode;
import com.java.FTPServer1.handle.*;
    ...
    public void executeCommand(String command, PrintWriter controlOutWriter, UserSession userSession) {
        ...
        switch (commandType) {
            ...
            case EPSV:
                ...
                break;
            case TYPE:
                connectionHandle.processTypeTransfer(commands[1], controlOutWriter);
                break;
            ...
            case STOR:
                ...
                break;
            case RETR:
                fileHandle.downloadFile(commands[1], controlOutWriter);
                break;
            case APPE:
                fileHandle.appendToFile(commands[1], controlOutWriter);
                break;
            case DELE:
